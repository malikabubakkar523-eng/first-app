...
async function main() {
  ...
  await prisma.storeSettings.upsert({
    ...
    create: {
      ...
      supportPhone: "+1 (800) 835-6231",
      address: "888 Madison Avenue, New York, NY 10021",
      freeShippingThreshold: 150,
      defaultShippingFee: 15,
      announcement: "Complimentary global express shipping on orders over $150. Use code VELOCE20 for 20% off your first purchase.",
        ...
        create: [
          {
            ...
            phone: "+1 (555) 349-8120",
            street: "450 Lexington Ave, Suite 1400",
            city: "New York",
            state: "NY",
            postalCode: "10017",
  ...
  await prisma.coupon.upsert({
    ...
    create: {
      code: "VELOCE20",
      description: "20% off on all orders over $100",
